  ...
  <main class="flex justify-center align-center p-10">
    <div class="w-fit max-w-lg p-8 bg-white shadow-lg rounded-lg">
      <div>
        ...
        <p class="mt-3 text-black w-fit">We're here to serve you. Let us know how we can help!</p>
      </div>
      <form @submit.prevent class="space-y-5 mt-5">
        <div>
          <label class="font-medium text-black">Full Name</label>
          <input
            type="text"
            required
        ...
        <div>
          <label class="font-medium text-black">Delivery Address</label>
        ...
        <div>
          <label class="font-medium text-black">Preferred Cuisine</label>
          <textarea
            required
